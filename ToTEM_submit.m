function varargout = ToTEM_submit(varargin)
% TOTEM_SUBMIT MATLAB code for ToTEM_submit.fig

% Last Modified by GUIDE v2.5 23-Mar-2021 19:38:35

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ToTEM_submit_OpeningFcn, ...
                   'gui_OutputFcn',  @ToTEM_submit_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before ToTEM_submit is made visible.
function ToTEM_submit_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to ToTEM_submit (see VARARGIN)

% Choose default command line output for ToTEM_submit
...
function varargout = ToTEM_submit_OutputFcn(hObject, eventdata, handles) 
...
%              CalAllEquilent20201106(all_nuclear_copy, all_nuc_ion_copy, absorp_n, absorp_n_i, eachthick, slicethick, flag);  
    ...
    series_n_corr, series_n_i_corr);
         ...
         if get(handles.radiobutton9,'value')  %hrtem像
             myresul=myresul+HRTEMsimulation(handles, ele_n, ele_n_i, absorp_n, absorp_n_i, series_n, series_n_i, mytcc. ele_n_corr, ele_n_i_corr, corr_info, ... %增加修正peng的系数，带入的修正势场的量
    series_n_corr, series_n_i_corr);
         end
      end
end
